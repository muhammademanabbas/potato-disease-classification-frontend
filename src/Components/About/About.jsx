      ...
      <div className="p-6 sm:p-8 lg:p-10 flex flex-col justify-center">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed text-base sm:text-lg">
            ...
            is designed to assist farmers and agricultural enthusiasts in early
            disease detection, enabling timely intervention and preventing
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed text-base sm:text-lg">
            ...
            pesticide usage, and ensure food security by protecting vital potato
            crops globally.
          </p>
        </section>
