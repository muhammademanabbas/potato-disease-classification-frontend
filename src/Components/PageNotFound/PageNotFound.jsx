...
const PageNotFound = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-500 to-emerald-600 p-4 font-sans">
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden max-w-2xl w-full mx-auto
        ...
        {/* Go Home Button */}
        {/* In a real React Router setup, you'd use <Link to="/"> instead of an anchor tag */}
        <Link
          to="/"
