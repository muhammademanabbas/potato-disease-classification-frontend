...
import { Link, useNavigation } from "react-router-dom"; // Import Link
  ...
  return (
    ...
    <div className="flex justify-center items-center min-h-screen p-5 bg-green-100 sm:p-10 font-inter">
      <div className="container bg-white mt-[14vh] p-8 rounded-2xl shadow-xl max-w-xl w-full flex flex-col gap-6">
        ...
        <Link
          to="/history"
          className="flex items-center justify-center gap-1 text-green-700 transition-colors duration-200 px-3 py-1 rounded-md border border-green-700 hover:bg-green-700 hover:text-white hover:border-green-700"
